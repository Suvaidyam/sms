    ...
    <>
      <section className="w-4/5 mx-auto bg-white rounded-lg shadow mt-5">
        <div className="w-full p-4   ">
          <h2 className="mb-4 text-xl text-center font-semibold text-gray-900 uppercase">
            ...
            <Form >
              ...
              <div className='md:flex'>
                <div className="w-full md:w-[30%] ">
                  <div className='w-full h-28 md:w-4/5 mt-5'>
                    {imagePreview ? (
                  ...
                  <div className='w-full md:w-4/5 mt-5 overflow-hidden'>
                ...
                <div className="w-full md:w-[70%] grid gap-4 sm:grid-cols-2 sm:gap-6">
                  ...
                  <div className='flex relative justify-center'>
                    <button
                      type="submit"
                      className=" text-white absolute top-10 bg-blue-600  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-sm text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                      Register
                    </button>
                  </div>
