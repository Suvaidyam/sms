...
interface SocialScienceProps { }

const SocialScience: FC<SocialScienceProps> = () => {
    ...
    return (
        <>
            ...
            {
                GanerateTask && <GeneraleTask onClose1={handleGeneraleTaskClose} Subject={'SocailScience'}/>
            }
            {<TeacherPage Subject={'SocailScience'} />}
        </>
    );
}
